...
def simple_uploaded_file(image_path):
    ...
    Args:
        image_path (str): Path absoluta de la imagen a "subir".
...
def get_image_path(name='test.png'):
    """Obtiene un path con la ruta y nombre de la imagen settings.MEDIA_ROOT/{name}.

    Args:
        name (str): Nombre de la imagen.

    Returns:
        El path con el nombre del archivo en forma de settings.MEDIA_ROOT/imagen.png
    """
